package com.delvinstudio.travelku;
...
public class RegisterTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backto = new Intent(RegisterTwoActivity.this, RegisterActivity.class);
                ...
                if(photo_loc != null){
                    ...
                    stor1.putFile(photo_loc).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            Intent nextto = new Intent(RegisterTwoActivity.this, LoginActivity.class);
